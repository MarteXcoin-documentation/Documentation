...
Budget System / DGBB
  ...
  Blockchain </Documentation/tree/master/governance#governance`_ (DGBB). For a fee, anybody can submit a
...
Confirmed Transactions
  ...
  usually after six confirmations. In the case of FastSend, funds can
...
MarteX
  ...
  <features>`_ page for a full list of MarteX's features.
...
MarteX Core Wallet 
  The `MarteX Core Wallet </Documentation/tree/master/wallets/MarteXcore>`_ (known also as the QT
...
MarteX Evolution
  ...
  decentralized. See the `Evolution </Documentation/blob/introduction/introduction/features.rst#evolution>`_ page for more 
  information.
...
Desktop Wallet
  ...
  We recommend any of the following: `MarteX Core Wallet. </Documentation/tree/master/wallets/MarteXcore>`_
...
Digital Wallet
  See `this link </Documentation/tree/master/wallets>`_ for full documentation on wallets.
  ...
  - **Desktop Wallet** (`MarteX Core Wallet 
    </Documentation/tree/master/wallets/MarteXcore>`_): Wallet programs that you install on a laptop 
  ...
  - **Mobile Wallet** (`Android </Documentation/tree/master/wallets/android>`_
...
Full Nodes
  ...
  desktop, or it could be a `masternode </Documentation/tree/master/masternode#masternode>`_. Full nodes
