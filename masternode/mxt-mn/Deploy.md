...
2. Fetch the script and execute it: <br> `cd /opt && git clone https://github.com/MarteXcoin-documentation/Documentation.git  && cd MarteXcoin-documentation/Documentation/masternode/mxt-mn && chmod +x MXT_deploy_mn.sh && ./MXT_deploy_mn.sh`
